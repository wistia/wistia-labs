...
function embedShepherdPluginCode(name, options) {
  return "<script src=\"//fast.wistia.com/assets/external/embed_shepherd-v1.js\"></script>\n" +
    "<scri" + "pt>\n" +
...
(function($) {
  ...
  $(function() {
    ...
    $('.in-beta').hover(function(){
      var $elem = $(this);
      $elem.find('.in-beta-original').toggle();
      $elem.find('.in-beta-on-hover').toggle();
    });
  });
