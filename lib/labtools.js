...
(function(W, $) {
  ...
  W.EmbedCode.serializeElem = function(elem) {
    var attr, child, contents, i, isValidName, isValidVal, name, pairs, tag, val, _i, _j, _len, _ref, _ref1;
    if (elem.nodeType === 1) {
      pairs = [];
      for (i = _i = 0, _ref = elem.attributes.length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
  ...
  W.AsyncEmbedCode = (function(_super) {
    __extends(AsyncEmbedCode, _super);
