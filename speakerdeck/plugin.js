...
Wistia.plugin('speakerdeck', function(video, options) {
  var Timings, aspect, deckElem, height, numberOfSlides, position, ready, readyCallback, slideChange, speakerDeck, suppressSlideSync, suppressSlideSyncTemporarily, t, tStr, timingPairs, timingStr, timings, updateSlideForTime, updateTimings, width, _i, _len, _ref;
  Timings = (function() {
  ...
  suppressSlideSyncTemporarily = function() {
    ...
    return Wistia.timeout("suppressSlideSyncTemporarily", function() {
  ...
  return {
    ...
    currentSlide: function() {
      var _ref1;
      return ((_ref1 = speakerDeck.currentSlide) != null ? _ref1.number : void 0) || 0;
    },
