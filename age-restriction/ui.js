...
AgeRestriction = (function() {
  function AgeRestriction() {
    ...
    this.change = false;
    this.exampleEmbedCode = '<div id="wistia_6s43yb8v80" class="wistia_embed" style="width:640px;height:360px;"> </div><script charset="ISO-8859-1" src="//fast.wistia.com/assets/external/E-v1.js"></script><script>wistiaEmbed = Wistia.embed("6s43yb8v80");</script>';
