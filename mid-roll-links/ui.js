...
Midroll = (function() {
  function Midroll() {
    ...
    this.change = false;
    this.exampleEmbedCode = '<div id="wistia_s1kuzpsgq0" class="wistia_embed" style="width:640px;height:360px;"> </div><script charset="ISO-8859-1" src="//fast.wistia.com/assets/external/E-v1.js"></script><script>wistiaEmbed = Wistia.embed("s1kuzpsgq0");</script>';
